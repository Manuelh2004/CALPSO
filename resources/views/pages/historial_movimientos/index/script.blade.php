...
<script>
    $(function () {
        ...
        const tabla_ajax =  $('#tabla_lista').DataTable({
            ...
            ajax: {
                "url": "crud/historial_movimientos/lista_ajax",
                "data": function (d) {
            ...
            columns: [
                { data: 'id_historial_movimientos' },
                { data: 'id_comprobante_pago' },
                { data: 'descripcion' },
            ],
        ...
        @include('pages.historial_movimientos.componentes.administrar_historial_movimientos_script');
