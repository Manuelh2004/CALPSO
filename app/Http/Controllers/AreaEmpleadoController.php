...
class AreaEmpleadoController extends Controller
{
    public function index() {
        return view('pages.area_empleado.index.content');
    }
    public function lista_ajax (Request $request): bool|string{
       ...
       $lista = areaEmpleado::listado_datatable($columnName, $columnSortOrder, $searchValue, $start, $rowperpage );
    ...
    public function data (Request $request){
        ...
        return areaEmpleado::get($id_area);
    }
    ...
    public function update (Request $request){
        ...
        return areaEmpleado::actualizar($id_area, $data_request);
    }
    public function create(Request $request)
    {
        ...
        return areaEmpleado::crear($data_request);
    }
}
