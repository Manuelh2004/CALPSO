...
class BlockController extends Controller
{
    public function index() {
        ...
        return View::make('pages.block.index.content')
    ...
    public function lista_ajax (Request $request){
        ...
        $lista = Block::listado_datatable($columnName, $columnSortOrder, $searchValue, $start, $rowperpage );
    ...
    public function create (Request $request){
        ...
        try {
            $validatedData = $request->validate([
                'psis_block_type' => 'required|min:6',
                'block_codename' => 'required|min:4',
                'block_name' => 'required|min:4',
                'block_serial' => 'required|min:6',
                'parent_block_id' => 'required',
                'block_longitude' => 'required',
                'block_latitude' => 'required',
                'block_altitude' => 'required',
    ...
    public function update (Request $request){
        ...
        return Block::actualizar($user_id, $data_request);
    }
