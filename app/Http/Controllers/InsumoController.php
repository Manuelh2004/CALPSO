...
class InsumoController extends Controller
{
    public function index() {
        return view('pages.insumo.index.content');
    }
    public function lista_ajax (Request $request): bool|string{
       ...
       $lista = Insumo::listado_datatable($columnName, $columnSortOrder, $searchValue, $start, $rowperpage );
    ...
    public function data (Request $request){
        ...
        $id_insumo = $request->input("id_insumo", 0);

        return Insumo::get($id_insumo);
    }
    public function update (Request $request){
        ...
        $id_insumo = $request->input("id_insumo", 0);
        $data_request = $request->only(['nombre_insumo','descripcion','stock']);

        return Insumo::actualizar($id_insumo, $data_request);
    }
    public function create(Request $request)
    {
        ...
        return Insumo::crear($data_request);
    }
}
